    ...
    <Link href={`/products/${product._id}`} className='sm:w-[292px] sm:max-w-[292px] w-full flex-1 flex flex-col gap-4 rounded-md'>
        <div className='flex-1 relative flex flex-col gap-5 p-4 rounded-md'>
            <Image
                ...
                width={200}
                height={200}
                className=' max-h-[250px] object-contain w-full h-full bg-transparent rounded-2xl'
            />
        </div>

        <div className='flex flex-col gap-3'>
            <h3 className='text-white text-xl leading-6 font-semibold truncate'>{product.title}</h3>
